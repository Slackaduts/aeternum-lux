...
if instance_exists(global.focusObject) && global.focusObject != undefined {
	camX = clamp(global.focusInstance.x - (viewWidth / 2), 0, room_width - viewWidth);
	camY = clamp(global.focusInstance.y - (viewHeight / 2), 0, room_height - viewHeight);
